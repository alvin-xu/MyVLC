...
import org.videolan.vlc.gui.AudioPlayerActivity;
import org.videolan.vlc.interfaces.IPlayerControl;
import org.videolan.vlc.interfaces.OnPlayerControlListener;
import org.videolan.vlc.gui.PlayerControlClassic;
import org.videolan.vlc.gui.PlayerControlWheel;
...
public class VideoPlayerActivity extends Activity implements IVideoPlayer {
    ...
    private IPlayerControl mControls;	//视频播放的控制接口
...
//        }
    ...
    */
    ...
    /**
    *	视频控制功能在此实现，播放、暂停、快进。。。
    *	真正的调用在PlayerControlClassic或者PlayerControlWheel中（这两个是视频控制的界面）
    */
     ...
     * 此处将显示视频的surface传到LibVLC中，这样LibVLC解码完的视频数据将直接显示到surface中？？？
     */
    ...
    /**
     * show overlay，包括锁定标识、头部、可选项、控制面板、进度条
     */
    ...
    private void play() {
        mLibVLC.play();
        mSurface.setKeepScreenOn(true);	//设置背景常亮
    }
